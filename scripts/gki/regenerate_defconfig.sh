...
export HOSTAR=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r530567/bin/llvm-ar
export HOSTCC=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r530567/bin/clang
export HOSTLD=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r530567/bin/ld.lld
export LD=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r530567/bin/ld.lld
export REAL_CC=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r530567/bin/clang
