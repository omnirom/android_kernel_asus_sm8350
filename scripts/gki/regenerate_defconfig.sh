...
export HOSTAR=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r450784e/bin/llvm-ar
export HOSTCC=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r450784e/bin/clang
export HOSTLD=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r450784e/bin/ld.lld
export LD=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r450784e/bin/ld.lld
export REAL_CC=$SOURCE_DIR/prebuilts/clang/host/linux-x86/clang-r450784e/bin/clang
